...
if($page == 'view') {
	...
	while ($row = $result->fetch_assoc()) {
		...
		<tr>
			...
			<td><?php echo $row['onset']; ?></td>
			<td><?php echo $row['type']; ?></td>
			<td><?php echo $row['weaning']; ?></td>
			<td><?php echo $row['eat_habit']; ?></td>
			<td><?php echo $row['drink_habit']; ?></td>
	...
	if ($input['action'] == 'edit') {
		$mysqli->query("
			...
			onset='" . $input['onset'] . "',
			type='" . $input['type'] . "',
			weaning='" . $input['weaning'] . "',
			eat_habit='" . $input['eat_habit'] . "',
			drink_habit='" . $input['drink_habit'] . "',
			urine='" . $input['urine'] . "',
			stool='" . $input['stool'] . "',
			other ='" . $input['other'] . "'
