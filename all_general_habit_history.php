...
<body onload="viewData()">
	...
	<script type="text/javascript">
		function viewData() {
			$.ajax({
				url: 'process/all_process_general_habit_history.php?p=view&pageno=<?php echo $pageno1?>',
				method: 'GET'
			}).done(function(data){
				$('tbody').html(data)
				tableData()
		...
		function tableData() {
			...
			$('#tabledit').Tabledit({
				...
				url: 'process/all_process_general_habit_history.php',
				eventType: 'dblclick',
				editButton: true,
				// editButton: false,
				deleteButton: true,
