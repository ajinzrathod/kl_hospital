...
<body onload="viewData()">
	...
	<section class="">
		...
		<div class="container-fluid">
			<h2> history_of_present_illness </h2>
				...
				<table id="tabledit" class="table table-striped table-hover">
					<thead>
						<tr>
							...
							<th> quality </th>
							<th> quantity </th>
							<th> provocative_factors </th>
							<th> associated_symptoms </th>
							<th> treatment_given_before </th>
	...
	<script type="text/javascript">
		function viewData() {
			$.ajax({
				url: 'process/02_process_history_of_present_illness.php?p=view&pageno=<?php echo $pageno1?>',
				method: 'GET'
			}).done(function(data){
				$('tbody').html(data)
				tableData()
		...
		function tableData() {
			...
			$('#tabledit').Tabledit({
				...
				url: 'process/02_process_history_of_present_illness.php',
				eventType: 'dblclick',
				editButton: true,
				// editButton: false,
				deleteButton: true,
				...
				columns: {
					...
					[2, 'quality'],
					[3, 'quantity'],
					[4, 'provocative_factors'],
					[5, 'associated_symptoms'],
					[6, 'treatment_given_before']
					]
				},
